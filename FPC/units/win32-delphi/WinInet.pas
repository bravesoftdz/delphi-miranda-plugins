...
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD): BOOL; overload; stdcall;
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PAnsiChar; dwContext: DWORD): BOOL; overload; stdcall;
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD): BOOL; overload; stdcall;
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PAnsiChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
...
type
  ...
  INTERNET_CACHE_GROUP_INFOA = record
    ...
    dwDiskUsage: DWORD;
    dwDiskQuota: DWORD;
    dwOwnerStorage: array[1..GROUPNAME_MAX_LENGTH] of DWORD;
    szGroupName: array[1..GROUP_OWNER_STORAGE_SIZE] of AnsiChar;
  end;
  ...
  INTERNET_CACHE_GROUP_INFOW = record
    ...
    dwDiskQuota: DWORD;
    dwOwnerStorage: array[1..GROUPNAME_MAX_LENGTH] of DWORD;
    szGroupName: array[1..GROUP_OWNER_STORAGE_SIZE] of WideChar;
  end;
...
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD): BOOL; external winetdll name 'FtpCommandW';
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PAnsiChar; dwContext: DWORD): BOOL; external winetdll name 'FtpCommandA';
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD): BOOL; external winetdll name 'FtpCommandW';
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandW';
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PAnsiChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandA';
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandW';
