...
function MAKELANGID(p, s: WORD): WORD; {inline;}
...
function MAKELCID(lgid, srtid: WORD): DWORD; {inline;}
function MAKESORTLCID(lgid, srtid, ver: WORD): DWORD; {inline;}
function LANGIDFROMLCID(lcid: DWORD): WORD; {inline;}
function SORTIDFROMLCID(lcid: DWORD): WORD; {inline;}
function SORTVERSIONFROMLCID(lcid: DWORD): WORD; {inline;}
...
{line 2900}
{ Security Descriptor and related data  }
...
type
  ...
  TTokenPrimaryGroup = _TOKEN_PRIMARY_GROUP;
  ...
  TTokenDefaultDacl = _TOKEN_DEFAULT_DACL;
...
type
  ...
  TTokenStatistics = _TOKEN_STATISTICS;
  ...
  _TOKEN_GROUPS_AND_PRIVILEGES = record
    ...
    RestrictedSidLength: ULONG;
    RestrictedSids: PSIDAndAttributes;
    PrivilegeCount: ULONG;
    PrivilegeLength: ULONG;
    Privileges: PLUIDAndAttributes;
    AuthenticationId: LUID;
  end;
  TTokenGroupsAndPrivileges = _TOKEN_GROUPS_AND_PRIVILEGES;
...
type
  ...
  TTokenAuditPolicy = _TOKEN_AUDIT_POLICY;
  ...
  _TOKEN_ACCESS_INFORMATION = record
    SidHash : PSIDAndAttributes;
    RestrictedSidHash: PSIDAndAttributes;
...
type
  ...
  HINST = type LongWord;
  HMODULE = type LongWord;      { HMODULEs can be used in place of HINSTs }
...
procedure MoveMemory(Destination: Pointer; Source: Pointer; Length: DWORD); {inline;}
procedure CopyMemory(Destination: Pointer; Source: Pointer; Length: DWORD); {inline;}
procedure FillMemory(Destination: Pointer; Length: DWORD; Fill: Byte); {inline;}
...
function InterlockedExchangePointer(var Target: Pointer; Value: Pointer): Pointer; {inline;}
function InterlockedCompareExchange(var Destination: Longint; Exchange: Longint; Comperand: Longint): Longint stdcall;
function InterlockedCompareExchangePointer(var Destination: Pointer; Exchange: Pointer; Comperand: Pointer): Pointer; {inline;}
...
function GetProcAddressW(hModule: HMODULE; lpProcName: LPCWSTR): FARPROC; stdcall;
...
function GetProcessHeaps(NumberOfHeaps: DWORD; var ProcessHeaps: PHandle): DWORD; stdcall;
...
function GetBinaryType(lpApplicationName: PWideChar; var lpBinaryType: DWORD): BOOL; stdcall;
...
function GetShortPathName(lpszLongPath: PWideChar; lpszShortPath: PWideChar;
...
function GetEnvironmentStrings: PWideChar; stdcall;
function GetEnvironmentStringsA: PAnsiChar; stdcall;
function GetEnvironmentStringsW: PWideChar; stdcall;
function FreeEnvironmentStrings(EnvBlock: PWideChar): BOOL; stdcall;
...
function ConvertThreadToFiber(lpParameter: Pointer): DWORD; stdcall;
...
function SetThreadIdealProcessor(hThread: THandle; dwIdealProcessor: DWORD): DWORD; stdcall;
...
procedure InitializeConditionVariable(out ConditionVariable: TRTLConditionVariable); stdcall;
procedure WakeConditionVariable(var ConditionVariable: TRTLConditionVariable); stdcall;
procedure WakeAllConditionVariable(var ConditionVariable: TRTLConditionVariable); stdcall;
function SleepConditionVariableCS(var ConditionVariable: TRTLConditionVariable; var CriticalSection: TRTLCriticalSection; dwMilliseconds: DWORD): BOOL; stdcall;
...
function CreateMailslot(lpName: PWideChar; nMaxMessageSize: DWORD;
...
function EncryptFile(lpFilename: PWideChar): BOOL; stdcall;
function EncryptFileA(lpFilename: PAnsiChar): BOOL; stdcall;
function EncryptFileW(lpFilename: PWideChar): BOOL; stdcall;
function DecryptFile(lpFilename: PWideChar; dwReserved: DWORD): BOOL; stdcall;
...
function OpenRaw(lpFilename: PWideChar; ulFlags: ULONG; pvContext: Pointer): DWORD; stdcall;
...
type
  ...
  _RECOVERY_AGENT_INFORMATION = _RECOVERY_AGENT_INFORMATIONW;
...
function QueryRecoveryAgents(p1: PWideChar; var p2: Pointer; var p3: TRecoveryAgentInformation): DWORD; stdcall;
...
function lstrcmp(lpString1, lpString2: PWideChar): Integer; stdcall;
...
function lstrcmpi(lpString1, lpString2: PWideChar): Integer; stdcall;
...
function lstrcpyn(lpString1, lpString2: PWideChar; iMaxLength: Integer): PWideChar; stdcall;
...
function lstrcpy(lpString1, lpString2: PWideChar): PWideChar; stdcall;
...
function lstrcat(lpString1, lpString2: PWideChar): PWideChar; stdcall;
...
function lstrlen(lpString: PWideChar): Integer; stdcall;
...
function UnregisterWait(WaitHandle: THandle): BOOL; stdcall; {__checkReturn}
function UnregisterWaitEx(WaitHandle: THandle; CompletionEvent: THandle): BOOL; stdcall; {__checkReturn}
{ #define WT_SET_MAX_THREADPOOL_THREADS(Flags, Limit)  ((Flags) |= (Limit)<<16) }
function WT_SET_MAX_THREADPOOL_THREADS(Flags, Limit: ULONG): ULONG; {inline;}
function QueueUserWorkItem(func: TThreadStartRoutine;
  Context: Pointer;
  Flags: ULONG): BOOL; stdcall;
function BindIoCompletionCallback(FileHandle: THandle;
  Callback: TPROverlappedCompletionRoutine; Flags: ULONG): BOOL; stdcall;
...
function CreateEventW(lpEventAttributes: PSecurityAttributes;
  bManualReset, bInitialState: BOOL; lpName: PWideChar): THandle; stdcall;
function OpenEvent(dwDesiredAccess: DWORD; bInheritHandle: BOOL; lpName: PWideChar): THandle; stdcall;
...
function CreateSemaphoreW(lpSemaphoreAttributes: PSecurityAttributes;
  lInitialCount, lMaximumCount: Longint; lpName: PWideChar): THandle; stdcall;
function OpenSemaphore(dwDesiredAccess: DWORD; bInheritHandle: BOOL; lpName: PWideChar): THandle; stdcall;
...
function CreateFileMappingW(hFile: THandle; lpFileMappingAttributes: PSecurityAttributes;
  flProtect, dwMaximumSizeHigh, dwMaximumSizeLow: DWORD; lpName: PWideChar): THandle; stdcall;
function OpenFileMapping(dwDesiredAccess: DWORD; bInheritHandle: BOOL; lpName: PWideChar): THandle; stdcall;
...
function GetLogicalDriveStrings(nBufferLength: DWORD; lpBuffer: PWideChar): DWORD; stdcall;
function GetLogicalDriveStringsA(nBufferLength: DWORD; lpBuffer: PAnsiChar): DWORD; stdcall;
function GetLogicalDriveStringsW(nBufferLength: DWORD; lpBuffer: PWideChar): DWORD; stdcall;
...
procedure FatalAppExit(uAction: UINT; lpMessageText: PWideChar); stdcall;
...
procedure GetStartupInfoA(out lpStartupInfo: TStartupInfoA); stdcall;
procedure GetStartupInfoW(out lpStartupInfo: TStartupInfoW); stdcall;
...
function GetEnvironmentVariable(lpName: PWideChar; lpBuffer: PWideChar; nSize: DWORD): DWORD; stdcall; overload;
...
function SetEnvironmentVariable(lpName, lpValue: PWideChar): BOOL; stdcall;
...
function FindResource(hModule: HMODULE; lpName, lpType: PWideChar): HRSRC; stdcall;
...
function FindResourceEx(hModule: HMODULE; lpType, lpName: PWideChar; wLanguage: Word): HRSRC; stdcall;
...
function EnumResourceTypesW(hModule: HMODULE; lpEnumFunc: ENUMRESTYPEPROC;
  lParam: Longint): BOOL; stdcall;
function EnumResourceNames(hModule: HMODULE; lpType: PWideChar;
...
function EnumResourceNamesW(hModule: HMODULE; lpType: PWideChar;
  lpEnumFunc: ENUMRESNAMEPROC; lParam: Longint): BOOL; stdcall;
function EnumResourceLanguages(hModule: HMODULE; lpType, lpName: PWideChar;
...
function EnumResourceLanguagesW(hModule: HMODULE; lpType, lpName: PWideChar;
  lpEnumFunc: ENUMRESLANGPROC; lParam: Longint): BOOL; stdcall;
function BeginUpdateResource(pFileName: PWideChar; bDeleteExistingResources: BOOL): THandle; stdcall;
...
function UpdateResource(hUpdate: THandle; lpType, lpName: PWideChar;
...
function GlobalGetAtomName(nAtom: ATOM; lpBuffer: PWideChar; nSize: Integer): UINT; stdcall;
...
function GetProfileInt(lpAppName, lpKeyName: PWideChar; nDefault: Integer): UINT; stdcall;
...
function GetProfileString(lpAppName, lpKeyName, lpDefault: PWideChar;
...
function GetProfileStringW(lpAppName, lpKeyName, lpDefault: PWideChar;
  lpReturnedString: PWideChar; nSize: DWORD): DWORD; stdcall;
function WriteProfileString(lpAppName, lpKeyName, lpString: PWideChar): BOOL; stdcall;
...
function GetProfileSection(lpAppName: PWideChar; lpReturnedString: PWideChar; nSize: DWORD): DWORD; stdcall;
...
function WriteProfileSection(lpAppName, lpString: PWideChar): BOOL; stdcall;
...
function GetPrivateProfileInt(lpAppName, lpKeyName: PWideChar; nDefault: Integer; lpFileName: PWideChar): UINT; stdcall;
...
function GetPrivateProfileString(lpAppName, lpKeyName, lpDefault: PWideChar;
...
function GetPrivateProfileStringW(lpAppName, lpKeyName, lpDefault: PWideChar;
  lpReturnedString: PWideChar; nSize: DWORD; lpFileName: PWideChar): DWORD; stdcall;
function WritePrivateProfileString(lpAppName, lpKeyName, lpString, lpFileName: PWideChar): BOOL; stdcall;
...
function GetPrivateProfileSection(lpAppName: PWideChar; lpReturnedString: PWideChar; nSize: DWORD; lpFileName: PWideChar): DWORD; stdcall;
...
function WritePrivateProfileSection(lpAppName, lpString, lpFileName: PWideChar): BOOL; stdcall;
...
function GetPrivateProfileSectionNames(lpszReturnBuffer: PWideChar; nSize: DWORD; lpFileName: PWideChar): DWORD; stdcall;
...
function GetPrivateProfileStruct(lpszSection, lpszKey: PWideChar;
...
function GetPrivateProfileStructW(lpszSection, lpszKey: PWideChar;
  lpStruct: Pointer; uSizeStruct: UINT; szFile: PWideChar): BOOL; stdcall;
function WritePrivateProfileStruct(lpszSection, lpszKey: PWideChar;
  lpStruct: Pointer; uSizeStruct: UINT; szFile: PWideChar): BOOL; stdcall;
...
function WritePrivateProfileStructW(lpszSection, lpszKey: PWideChar;
  lpStruct: Pointer; uSizeStruct: UINT; szFile: PWideChar): BOOL; stdcall;
function GetDriveType(lpRootPathName: PWideChar): UINT; stdcall;
...
function CreateDirectoryW(lpPathName: PWideChar;
  lpSecurityAttributes: PSecurityAttributes): BOOL; stdcall;
function CreateDirectoryEx(lpTemplateDirectory, lpNewDirectory: PWideChar;
  lpSecurityAttributes: PSecurityAttributes): BOOL; stdcall;
...
function DefineDosDevice(dwFlags: DWORD; lpDeviceName, lpTargetPath: PWideChar): BOOL; stdcall;
...
function QueryDosDevice(lpDeviceName: PWideChar; lpTargetPath: PWideChar; ucchMax: DWORD): DWORD; stdcall;
...
function CreateFileW(lpFileName: PWideChar; dwDesiredAccess, dwShareMode: DWORD;
  lpSecurityAttributes: PSecurityAttributes; dwCreationDisposition, dwFlagsAndAttributes: DWORD;
  hTemplateFile: THandle): THandle; stdcall;
function SetFileAttributes(lpFileName: PWideChar; dwFileAttributes: DWORD): BOOL; stdcall;
...
function GetFileAttributes(lpFileName: PWideChar): DWORD; stdcall;
...
function GetFileAttributesEx(lpFileName: PWideChar;
...
function GetFileAttributesExW(lpFileName: PWideChar;
  fInfoLevelId: TGetFileExInfoLevels; lpFileInformation: Pointer): BOOL; stdcall;
function GetCompressedFileSize(lpFileName: PWideChar; lpFileSizeHigh: PDWORD): DWORD; stdcall;
...
function FindFirstFileEx(lpFileName: PWideChar; fInfoLevelId: TFindexInfoLevels;
...
function SearchPath(lpPath, lpFileName, lpExtension: PWideChar;
...
function MoveFileEx(lpExistingFileName, lpNewFileName: PWideChar; dwFlags: DWORD): BOOL; stdcall;
...
function MoveFileWithProgress(lpExistingFileName, lpNewFileName: PWideChar; lpProgressRoutine: TFNProgressRoutine;
...
function CreateHardLink(lpFileName, lpExistingFileName: PWideChar;
  lpSecurityAttributes: PSecurityAttributes): BOOL; stdcall;
...
function CreateHardLinkW(lpFileName, lpExistingFileName: PWideChar;
  lpSecurityAttributes: PSecurityAttributes): BOOL; stdcall;
function CreateNamedPipe(lpName: PWideChar;
...
function GetNamedPipeHandleStateW(hNamedPipe: THandle;
  lpState, lpCurInstances, lpMaxCollectionCount, lpCollectDataTimeout: PDWORD;
  lpUserName: PWideChar; nMaxUserNameSize: DWORD): BOOL; stdcall;
function CallNamedPipe(lpNamedPipeName: PWideChar; lpInBuffer: Pointer;
  nInBufferSize: DWORD; lpOutBuffer: Pointer; nOutBufferSize: DWORD;
...
function CallNamedPipeW(lpNamedPipeName: PWideChar; lpInBuffer: Pointer;
  nInBufferSize: DWORD; lpOutBuffer: Pointer; nOutBufferSize: DWORD;
  var lpBytesRead: DWORD; nTimeOut: DWORD): BOOL; stdcall;
function WaitNamedPipe(lpNamedPipeName: PWideChar; nTimeOut: DWORD): BOOL; stdcall;
...
function SetVolumeLabel(lpRootPathName: PWideChar; lpVolumeName: PWideChar): BOOL; stdcall;
...
function ClearEventLog(hEventLog: THandle; lpBackupFileName: PWideChar): BOOL; stdcall;
...
function BackupEventLog(hEventLog: THandle; lpBackupFileName: PWideChar): BOOL; stdcall;
...
function OpenEventLog(lpUNCServerName, lpSourceName: PWideChar): THandle; stdcall;
...
function RegisterEventSource(lpUNCServerName, lpSourceName: PWideChar): THandle; stdcall;
...
function OpenBackupEventLog(lpUNCServerName, lpFileName: PWideChar): THandle; stdcall;
...
function AccessCheckAndAuditAlarm(SubsystemName: PWideChar;
...
function AccessCheckAndAuditAlarmW(SubsystemName: PWideChar;
  ...
  const GenericMapping: TGenericMapping;  ObjectCreation: BOOL;
  var GrantedAccess: DWORD; var AccessStatus, pfGenerateOnClose: BOOL): BOOL; stdcall;
function AccessCheckByTypeAndAuditAlarm(SubsystemName: PWideChar;
  HandleId: Pointer; ObjectTypeName, ObjectName: PWideChar;
...
function AccessCheckByTypeAndAuditAlarmW(SubsystemName: PWideChar;
  ...
  ObjectTypeListLength: DWORD; const GenericMapping: TGenericMapping;  ObjectCreation: BOOL;
  var GrantedAccess: DWORD; var AccessStatus, pfGenerateOnClose: BOOL): BOOL; stdcall;
function AccessCheckByTypeResultListAndAuditAlarm(SubsystemName: PWideChar;
  HandleId: Pointer; ObjectTypeName, ObjectName: PWideChar;
  SecurityDescriptor: PSecurityDescriptor; PrincipalSelfSid: PSID; DesiredAccess: DWORD;
  AuditType: AUDIT_EVENT_TYPE; Flags: DWORD; ObjectTypeList: PObjectTypeList;
  ObjectTypeListLength: DWORD; const GenericMapping: TGenericMapping;  ObjectCreation: BOOL;
...
function AccessCheckByTypeResultListAndAuditAlarmW(SubsystemName: PWideChar;
  ...
  ObjectTypeListLength: DWORD; const GenericMapping: TGenericMapping;  ObjectCreation: BOOL;
  var GrantedAccess: DWORD; var AccessStatusList: DWORD; var pfGenerateOnClose: BOOL): BOOL; stdcall;
function ObjectOpenAuditAlarm(SubsystemName: PWideChar; HandleId: Pointer;
...
function ObjectOpenAuditAlarmW(SubsystemName: PWideChar; HandleId: Pointer;
  ...
  var Privileges: TPrivilegeSet; ObjectCreation, AccessGranted: BOOL;
  var GenerateOnClose: BOOL): BOOL; stdcall;
function ObjectPrivilegeAuditAlarm(SubsystemName: PWideChar;
...
function ObjectPrivilegeAuditAlarmW(SubsystemName: PWideChar;
  HandleId: Pointer; ClientToken: THandle; DesiredAccess: DWORD;
  var Privileges: TPrivilegeSet; AccessGranted: BOOL): BOOL; stdcall;
function ObjectCloseAuditAlarm(SubsystemName: PWideChar;
...
function ObjectCloseAuditAlarmW(SubsystemName: PWideChar;
  HandleId: Pointer; GenerateOnClose: BOOL): BOOL; stdcall;
function ObjectDeleteAuditAlarm(SubsystemName: PWideChar;
  HandleId: Pointer; GenerateOnClose: BOOL): BOOL; stdcall;
function ObjectDeleteAuditAlarmA(SubsystemName: PAnsiChar;
  HandleId: Pointer; GenerateOnClose: BOOL): BOOL; stdcall;
function ObjectDeleteAuditAlarmW(SubsystemName: PWideChar;
  HandleId: Pointer; GenerateOnClose: BOOL): BOOL; stdcall;
function PrivilegedServiceAuditAlarm(SubsystemName, ServiceName: PWideChar;
...
function SetFileSecurity(lpFileName: PWideChar; SecurityInformation: SECURITY_INFORMATION;
...
function SetFileSecurityW(lpFileName: PWideChar; SecurityInformation: SECURITY_INFORMATION;
  pSecurityDescriptor: PSecurityDescriptor): BOOL; stdcall;
function GetFileSecurity(lpFileName: PWideChar; RequestedInformation: SECURITY_INFORMATION;
...
function FindFirstChangeNotification(lpPathName: PWideChar;
...
function IsBadStringPtr(lpsz: PWideChar; ucchMax: UINT): BOOL; stdcall;
...
function LookupAccountSid(lpSystemName: PWideChar; Sid: PSID;
...
function LookupAccountNameW(lpSystemName, lpAccountName: PWideChar;
  Sid: PSID; var cbSid: DWORD; ReferencedDomainName: PWideChar;
  var cbReferencedDomainName: DWORD; var peUse: SID_NAME_USE): BOOL; stdcall;
function LookupPrivilegeValue(lpSystemName, lpName: PWideChar;
...
function LookupPrivilegeValueW(lpSystemName, lpName: PWideChar;
  var lpLuid: TLargeInteger): BOOL; stdcall;
function LookupPrivilegeName(lpSystemName: PWideChar;
...
function LookupPrivilegeNameW(lpSystemName: PWideChar;
  var lpLuid: TLargeInteger; lpName: PWideChar; var cbName: DWORD): BOOL; stdcall;
function LookupPrivilegeDisplayName(lpSystemName, lpName: PWideChar;
...
function BuildCommDCB(lpDef: PWideChar; var lpDCB: TDCB): BOOL; stdcall;
...
function BuildCommDCBAndTimeouts(lpDef: PWideChar; var lpDCB: TDCB;
...
function BuildCommDCBAndTimeoutsW(lpDef: PWideChar; var lpDCB: TDCB;
  var lpCommTimeouts: TCommTimeouts): BOOL; stdcall;
function CommConfigDialog(lpszName: PWideChar; hWnd: HWND; var lpCC: TCommConfig): BOOL; stdcall;
...
function GetDefaultCommConfig(lpszName: PWideChar;
...
function GetDefaultCommConfigW(lpszName: PWideChar;
  var lpCC: TCommConfig; var lpdwSize: DWORD): BOOL; stdcall;
function SetDefaultCommConfig(lpszName: PWideChar; lpCC: PCommConfig; dwSize: DWORD): BOOL; stdcall;
...
function GetComputerName(lpBuffer: PWideChar; var nSize: DWORD): BOOL; stdcall;
...
function SetComputerName(lpComputerName: PWideChar): BOOL; stdcall;
...
function LogonUser(lpszUsername, lpszDomain, lpszPassword: PWideChar;
...
function CreateProcessAsUser(hToken: THandle; lpApplicationName: PWideChar;
...
function CreateProcessAsUserA(hToken: THandle; lpApplicationName: PAnsiChar;
  ...
  const lpStartupInfo: TStartupInfoA; var lpProcessInformation: TProcessInformation): BOOL; stdcall;
...
type
  ...
  tagHW_PROFILE_INFO = tagHW_PROFILE_INFOW;
...
{ Security Status Codes }
  ...
  { already be mapped to non-generic  }
...
type
  ...
  tagLOGCOLORSPACE = tagLOGCOLORSPACEW;
...
type
  ...
  tagNEWTEXTMETRIC = tagNEWTEXTMETRICW;
...
type
  ...
  tagENUMLOGFONT = tagENUMLOGFONTW;
  ...
  tagENUMLOGFONTEX = tagENUMLOGFONTEXW;
...
type
  ...
  tagGCP_RESULTS = tagGCP_RESULTSW;
...
function AddFontResource(FileName: PWideChar): Integer; stdcall;
...
function CopyMetaFile(p1: HMETAFILE; p2: PWideChar): HMETAFILE; stdcall;
...
function CreateDC(lpszDriver, lpszDevice, lpszOutput: PWideChar;
...
function CreateIC(lpszDriver, lpszDevice, lpszOutput: PWideChar; lpdvmInit: PDeviceMode): HDC; stdcall;
...
function CreateMetaFile(p1: PWideChar): HDC; stdcall;
...
function CreateScalableFontResource(p1: DWORD; p2, p3, p4: PWideChar): BOOL; stdcall;
...
function EnumFontFamilies(DC: HDC; p2: PWideChar; p3: TFNFontEnumProc; p4: LPARAM): BOOL; stdcall;
...
function EnumFonts(DC: HDC; lpszFace: PWideChar; fntenmprc: TFNFontEnumProc;
  lParam: LPARAM): Integer; stdcall; overload;
...
function EnumFontsW(DC: HDC; lpszFace: PWideChar; fntenmprc: TFNFontEnumProcW;
  lParam: LPARAM): Integer; stdcall; overload;
function EnumFonts(DC: HDC; lpszFace: PWideChar; fntenmprc: TFNFontEnumProc;
  lpszData: PWideChar): Integer; stdcall; overload;
function EnumFontsA(DC: HDC; lpszFace: PAnsiChar; fntenmprc: TFNFontEnumProcA;
  lpszData: PAnsiChar): Integer; stdcall; overload;
function EnumFontsW(DC: HDC; lpszFace: PWideChar; fntenmprc: TFNFontEnumProcW;
  lpszData: PWideChar): Integer; stdcall; overload;
...
function GetMetaFile(p1: PWideChar): HMETAFILE; stdcall;
...
function GetTextExtentPoint(DC: HDC; Str: PWideChar; Count: Integer;
...
function GetTextExtentPoint32(DC: HDC; const Str: UnicodeString; Count: Integer;
  var Size: TSize): BOOL; overload; {inline;}
...
function GetTextExtentPoint32W(DC: HDC; const Str: UnicodeString; Count: Integer;
  var Size: TSize): BOOL; overload; {inline;}
function GetTextExtentExPoint(DC: HDC; p2: PWideChar;
...
function GetCharacterPlacement(DC: HDC; p2: PWideChar; p3, p4: Integer;
...
function GetGlyphIndices(DC: HDC; p2: PWideChar; p3: Integer; p4: PWORD; p5: DWORD): DWORD; stdcall;
...
function AddFontResourceEx(p1: PWideChar; p2: DWORD; p3: PDesignVector): Integer; stdcall;
...
function RemoveFontResourceEx(p1: PWideChar; p2: DWORD; p3: PDesignVector): BOOL; stdcall;
...
function RemoveFontResource(FileName: PWideChar): BOOL; stdcall;
...
function SetMetaFileBitsEx(Size: UINT; const Data: PByte): HMETAFILE; stdcall;
...
function CopyEnhMetaFile(p1: HENHMETAFILE; p2: PWideChar): HENHMETAFILE; stdcall;
...
function CreateEnhMetaFile(DC: HDC; FileName: PWideChar; Rect: PRect; Desc: PWideChar): HDC; stdcall;
...
function GetEnhMetaFile(p1: PWideChar): HENHMETAFILE; stdcall;
...
function GetEnhMetaFileDescription(p1: HENHMETAFILE; p2: UINT; p3: PWideChar): UINT; stdcall;
...
function SetEnhMetaFileBits(p1: UINT; p2: PByte): HENHMETAFILE; stdcall;
function SetWinMetaFileBits(p1: UINT; p2: PByte; p3: HDC;
  const p4: TMetaFilePict): HENHMETAFILE; stdcall;
function GdiComment(DC: HDC; p2: UINT; p3: PAnsiChar): BOOL; stdcall;
...
function TextOut(DC: HDC; X, Y: Integer; Str: PWideChar; Count: Integer): BOOL; stdcall;
...
function ExtTextOut(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; Str: PWideChar; Count: Longint; Dx: PInteger): BOOL; overload; stdcall;
function ExtTextOutA(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; Str: PAnsiChar; Count: Longint; Dx: PInteger): BOOL; overload; stdcall;
function ExtTextOutW(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; Str: PWideChar; Count: Longint; Dx: PInteger): BOOL; overload; stdcall;
function ExtTextOut(DC: HDC; X, Y: Integer; Options: Longint;
  const Rect: TRect; const Str: UnicodeString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
function ExtTextOutA(DC: HDC; X, Y: Integer; Options: Longint;
  const Rect: TRect; const Str: AnsiString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
function ExtTextOutW(DC: HDC; X, Y: Integer; Options: Longint;
  const Rect: TRect; const Str: UnicodeString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
function ExtTextOut(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; const Str: UnicodeString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
function ExtTextOutA(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; const Str: AnsiString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
function ExtTextOutW(DC: HDC; X, Y: Integer; Options: Longint;
  Rect: PRect; const Str: UnicodeString; Count: Longint; Dx: PInteger): BOOL; overload; {inline;}
...
function GetTextFace(DC: HDC; Count: Integer; Buffer: PWideChar): Integer; stdcall;
...
function GetICMProfile(DC: HDC; var Size: DWORD; Name: PWideChar): BOOL; stdcall;
...
function SetICMProfile(DC: HDC; Name: PWideChar): BOOL; stdcall;
...
function UpdateICMRegKey(p1: DWORD; p2, p3: PWideChar; p4: UINT): BOOL; stdcall;
...
function wvsprintf(Output: PWideChar; Format: PWideChar; arglist: va_list): Integer; stdcall;
...
function wsprintf(Output: PWideChar; Format: PWideChar): Integer; stdcall;
...
type
  ...
  tagCREATESTRUCT = tagCREATESTRUCTW;
...
function GET_APPCOMMAND_LPARAM(const lParam: LongInt): Shortint; {inline;}
function GET_DEVICE_LPARAM(const lParam: LongInt): Word; {inline;}
function GET_MOUSEORKEY_LPARAM(const lParam: LongInt): Word; {inline;}
function GET_FLAGS_LPARAM(const lParam: LongInt): Word; {inline;}
function GET_KEYSTATE_LPARAM(const lParam: LongInt): Word; {inline;}
...
function LoadKeyboardLayout(pwszKLID: PWideChar; Flags: UINT): HKL; overload; stdcall;
function LoadKeyboardLayoutA(pwszKLID: PAnsiChar; Flags: UINT): HKL; overload; stdcall;
function LoadKeyboardLayoutW(pwszKLID: PWideChar; Flags: UINT): HKL; overload; stdcall;
function LoadKeyboardLayout(const pwszKLID: UnicodeString; Flags: UINT): HKL; overload; {inline;}
function LoadKeyboardLayoutA(const pwszKLID: AnsiString; Flags: UINT): HKL; overload; {inline;}
function LoadKeyboardLayoutW(const pwszKLID: UnicodeString; Flags: UINT): HKL; overload; {inline;}
...
function GetKeyboardLayoutName(pwszKLID: PWideChar): BOOL; stdcall;
...
function CreateDesktop(lpszDesktop, lpszDevice: PWideChar;
...
function CreateDesktopW(lpszDesktop, lpszDevice: PWideChar;
  ...
  DWORD; lpsa: PSecurityAttributes): HDESK; stdcall;
function OpenDesktop(lpszDesktop: PWideChar; dwFlags: DWORD; fInherit: BOOL;
...
function CreateWindowStation(lpwinsta: PWideChar; dwReserved, dwDesiredAccess: DWORD;
...
function CreateWindowStationW(lpwinsta: PWideChar; dwReserved, dwDesiredAccess: DWORD;
  lpsa: PSecurityAttributes): HWINSTA; stdcall;
function OpenWindowStation(lpszWinSta: PWideChar; fInherit: BOOL;
...
function PointToLParam(P: TPoint): LPARAM; {inline;}
...
function RegisterWindowMessage(lpString: PWideChar): UINT; stdcall;
...
function UnregisterClass(lpClassName: PWideChar; hInstance: HINST): BOOL; stdcall;
...
function GetClassInfo(hInstance: HINST; lpClassName: PWideChar;
...
function GetClassInfoEx(Instance: HINST; Classname: PWideChar; var WndClass: TWndClassEx): BOOL; stdcall;
...
function CreateWindowEx(dwExStyle: DWORD; lpClassName: PWideChar;
...
function GetWindowPlacement(hWnd: HWND; WindowPlacement: PWindowPlacement): BOOL; overload; stdcall;
function GetWindowPlacement(hWnd: HWND; var WindowPlacement: TWindowPlacement): BOOL; overload; stdcall;
function SetWindowPlacement(hWnd: HWND; WindowPlacement: PWindowPlacement): BOOL; overload; stdcall;
function SetWindowPlacement(hWnd: HWND; const WindowPlacement: TWindowPlacement): BOOL; overload; stdcall;
...
function CreateDialogParam(hInstance: HINST; lpTemplateName: PWideChar;
...
function CreateDialogIndirectParamW(hInstance: HINST; const lpTemplate: TDlgTemplate;
  hWndParent: HWND; lpDialogFunc: TFNDlgProc; dwInitParam: LPARAM): HWND; stdcall;
function CreateDialog(hInstance: HINST; lpTemplateName: PWideChar;
...
function CreateDialogIndirectW(hInstance: HINST; const lpTemplate: TDlgTemplate;
  hWndParent: HWND; lpDialogFunc: TFNDlgProc): HWND;
function DialogBoxParam(hInstance: HINST; lpTemplateName: PWideChar;
...
function DialogBoxIndirectParamW(hInstance: HINST; const lpDialogTemplate: TDlgTemplate;
  hWndParent: HWND; lpDialogFunc: TFNDlgProc; dwInitParam: LPARAM): Integer; stdcall;
function DialogBox(hInstance: HINST; lpTemplate: PWideChar;
...
function SetDlgItemText(hDlg: HWND; nIDDlgItem: Integer; lpString: PWideChar): BOOL; stdcall;
...
function RegisterClipboardFormat(lpszFormat: PWideChar): UINT; stdcall;
...
function GetClipboardFormatName(format: UINT; lpszFormatName: PWideChar;
...
function CharToOem(lpszSrc: PWideChar; lpszDst: PAnsiChar): BOOL; stdcall;
function CharToOemA(lpszSrc: PAnsiChar; lpszDst: PAnsiChar): BOOL; stdcall;
function CharToOemW(lpszSrc: PWideChar; lpszDst: PAnsiChar): BOOL; stdcall;
function OemToChar(lpszSrc: PAnsiChar; lpszDst: PWideChar): BOOL; stdcall;
function OemToCharA(lpszSrc: PAnsiChar; lpszDst: PAnsiChar): BOOL; stdcall;
function OemToCharW(lpszSrc: PAnsiChar; lpszDst: PWideChar): BOOL; stdcall;
function CharToOemBuff(lpszSrc: PWideChar; lpszDst: PAnsiChar; cchDstLength: DWORD): BOOL; stdcall;
function CharToOemBuffA(lpszSrc: PAnsiChar; lpszDst: PAnsiChar; cchDstLength: DWORD): BOOL; stdcall;
function CharToOemBuffW(lpszSrc: PWideChar; lpszDst: PAnsiChar; cchDstLength: DWORD): BOOL; stdcall;
function OemToCharBuff(lpszSrc: PAnsiChar; lpszDst: PWideChar; cchDstLength: DWORD): BOOL; stdcall;
function OemToCharBuffA(lpszSrc: PAnsiChar; lpszDst: PAnsiChar; cchDstLength: DWORD): BOOL; stdcall;
function OemToCharBuffW(lpszSrc: PAnsiChar; lpszDst: PWideChar; cchDstLength: DWORD): BOOL; stdcall;
function CharUpper(lpsz: PWideChar): PWideChar; stdcall;
function CharUpperA(lpsz: PAnsiChar): PAnsiChar; stdcall;
function CharUpperW(lpsz: PWideChar): PWideChar; stdcall;
function CharUpperBuff(lpsz: PWideChar; cchLength: DWORD): DWORD; stdcall;
...
function CharLower(lpsz: PWideChar): PWideChar; stdcall;
function CharLowerA(lpsz: PAnsiChar): PAnsiChar; stdcall;
function CharLowerW(lpsz: PWideChar): PWideChar; stdcall;
function CharLowerBuff(lpsz: PWideChar; cchLength: DWORD): DWORD; stdcall;
...
function CharNext(lpsz: PWideChar): PWideChar; stdcall;
function CharNextA(lpsz: PAnsiChar): PAnsiChar; stdcall;
function CharNextW(lpsz: PWideChar): PWideChar; stdcall;
function CharPrev(lpszStart: PWideChar; lpszCurrent: PWideChar): PWideChar; stdcall;
...
function GetKeyNameText(lParam: Longint; lpString: PWideChar; nSize: Integer): Integer; stdcall;
...
function VkKeyScan(ch: WideChar): SHORT; stdcall;
function VkKeyScanA(ch: AnsiChar): SHORT; stdcall;
function VkKeyScanW(ch: WideChar): SHORT; stdcall;
function VkKeyScanEx(ch: WideChar; dwhkl: HKL): SHORT; stdcall;
...
function LoadAccelerators(hInstance: HINST; lpTableName: PWideChar): HACCEL; stdcall;
...
function LoadMenu(hInstance: HINST; lpMenuName: PWideChar): HMENU; stdcall;
...
function ChangeMenu(hMenu: HMENU; cmd: UINT; lpszNewItem: PWideChar;
...
function GetMenuString(hMenu: HMENU; uIDItem: UINT; lpString: PWideChar;
...
type
  ...
  tagMENUITEMINFO = tagMENUITEMINFOW;
...
function MenuItemFromPoint(hWnd: HWND; hMenu: HMENU; ptScreen: TPoint): Integer; stdcall;
...
function DrawText(hDC: HDC; lpString: PWideChar; nCount: Integer;
  var lpRect: TRect; uFormat: UINT): Integer; overload; stdcall;
...
function DrawText(hDC: HDC; const lpString: UnicodeString; nCount: Integer;
  var lpRect: TRect; uFormat: UINT): Integer; overload; {inline;}
...
function DrawTextW(hDC: HDC; const lpString: UnicodeString; nCount: Integer;
  var lpRect: TRect; uFormat: UINT): Integer; overload; {inline;}
function DrawTextEx(DC: HDC; lpchText: PWideChar; cchText: Integer; var p4: TRect;
...
function DrawStateW(DC: HDC; Brush: HBRUSH; CBFunc: TFNDrawStateProc;
  lData: LPARAM; wData: WPARAM; x, y, cx, cy: Integer; Flags: UINT): BOOL; stdcall;
function TabbedTextOut(hDC: HDC; X, Y: Integer; lpString: PWideChar; nCount, nTabPositions: Integer;
...
function TabbedTextOutW(hDC: HDC; X, Y: Integer; lpString: PWideChar; nCount, nTabPositions: Integer;
  var lpnTabStopPositions; nTabOrigin: Integer): Longint; stdcall;
function GetTabbedTextExtent(hDC: HDC; lpString: PWideChar;
...
function InvalidateRect(hWnd: HWND; const lpRect: TRect; bErase: BOOL): BOOL; overload; stdcall;
function ValidateRect(hWnd: HWND; lpRect: PRect): BOOL; overload; stdcall;
function ValidateRect(hWnd: HWND; const lpRect: TRect): BOOL; overload; stdcall;
function InvalidateRgn(hWnd: HWND; hRgn: HRGN; bErase: BOOL): BOOL; stdcall;
function ValidateRgn(hWnd: HWND; hRgn: HRGN): BOOL; stdcall;
function RedrawWindow(hWnd: HWND; lprcUpdate: PRect; hrgnUpdate: HRGN; flags: UINT): BOOL; overload; stdcall;
function RedrawWindow(hWnd: HWND; const lprcUpdate: TRect; hrgnUpdate: HRGN; flags: UINT): BOOL; overload; stdcall;
...
function ScrollWindowEx(hWnd: HWND; dx, dy: Integer;
  ...
  hrgnUpdate: HRGN; prcUpdate: PRect; flags: UINT): BOOL; overload; stdcall;
function ScrollWindowEx(hWnd: HWND; dx, dy: Integer;
...
function SetProp(hWnd: HWND; lpString: PWideChar; hData: THandle): BOOL; stdcall;
...
function GetProp(hWnd: HWND; lpString: PWideChar): THandle; stdcall;
...
function RemoveProp(hWnd: HWND; lpString: PWideChar): THandle; stdcall;
...
function SetWindowText(hWnd: HWND; lpString: PWideChar): BOOL; stdcall; overload;
function SetWindowTextA(hWnd: HWND; lpString: PAnsiChar): BOOL; stdcall; overload;
function SetWindowTextW(hWnd: HWND; lpString: PWideChar): BOOL; stdcall; overload;
function SetWindowText(hWnd: HWND; const lpString: UnicodeString): BOOL; overload; {inline;}
function SetWindowTextA(hWnd: HWND; const lpString: AnsiString): BOOL; overload; {inline;}
function SetWindowTextW(hWnd: HWND; const lpString: UnicodeString): BOOL; overload; {inline;}
...
function MessageBoxEx(hWnd: HWND; lpText, lpCaption: PWideChar;
...
type
  ...
  tagMSGBOXPARAMS = tagMSGBOXPARAMSW;
...
function EnumChildWindows(hWndParent: HWND; lpEnumFunc: TFNWndEnumProc;
  lParam: LPARAM): BOOL; stdcall;
function FindWindow(lpClassName, lpWindowName: PWideChar): HWND; stdcall;
...
function FindWindowEx(Parent, Child: HWND; ClassName, WindowName: PWideChar): HWND; stdcall;
...
function GetClassName(hWnd: HWND; lpClassName: PWideChar; nMaxCount: Integer): Integer; stdcall;
...
function LoadBitmap(hInstance: HINST; lpBitmapName: PWideChar): HBITMAP; stdcall;
...
function LoadCursor(hInstance: HINST; lpCursorName: PWideChar): HCURSOR; overload; stdcall;
function LoadCursorA(hInstance: HINST; lpCursorName: PAnsiChar): HCURSOR; overload; stdcall;
function LoadCursorW(hInstance: HINST; lpCursorName: PWideChar): HCURSOR; overload; stdcall;
function LoadCursor(hInstance: HINST; const lpCursorName: UnicodeString): HCURSOR; {inline;} overload;
function LoadCursorA(hInstance: HINST; const lpCursorName: AnsiString): HCURSOR; {inline;} overload;
function LoadCursorW(hInstance: HINST; const lpCursorName: UnicodeString): HCURSOR; {inline;} overload;
function LoadCursorFromFile(lpFileName: PWideChar): HCURSOR; stdcall;
...
function LoadIcon(hInstance: HINST; lpIconName: PWideChar): HICON; stdcall;
...
function LoadImage(hInst: HINST; ImageName: PWideChar; ImageType: UINT; X, Y: Integer; Flags: UINT): THandle; stdcall;
...
function DlgDirList(hDlg: HWND; lpPathSpec: PWideChar;
...
function DlgDirSelectEx(hDlg: HWND; lpString: PWideChar; nCount, nIDListBox: Integer): BOOL; stdcall;
...
function DlgDirListComboBox(hDlg: HWND; lpPathSpec: PWideChar;
...
function DlgDirListComboBoxW(hDlg: HWND; lpPathSpec: PWideChar;
  nIDComboBox, nIDStaticPath: Integer; uFiletype: UINT): Integer; stdcall;
function DlgDirSelectComboBoxEx(hDlg: HWND; lpString: PWideChar;
...
type
  ...
  tagMDICREATESTRUCT = tagMDICREATESTRUCTW;
...
function CreateMDIWindow(lpClassName, lpWindowName: PWideChar;
...
type
  ...
  tagMULTIKEYHELP = tagMULTIKEYHELPW;
  ...
  tagHELPWININFO = tagHELPWININFOW;
...
function WinHelp(hWndMain: HWND; lpszHelp: PWideChar; uCommand: UINT; dwData: DWORD): BOOL; overload; stdcall;
function WinHelpA(hWndMain: HWND; lpszHelp: PAnsiChar; uCommand: UINT; dwData: DWORD): BOOL; overload; stdcall;
function WinHelpW(hWndMain: HWND; lpszHelp: PWideChar; uCommand: UINT; dwData: DWORD): BOOL; overload; stdcall;
function WinHelp(hWndMain: HWND; const lpszHelp: UnicodeString; uCommand: UINT; dwData: DWORD): BOOL; overload; {inline;}
function WinHelpA(hWndMain: HWND; const lpszHelp: AnsiString; uCommand: UINT; dwData: DWORD): BOOL; overload; {inline;}
function WinHelpW(hWndMain: HWND; const lpszHelp: UnicodeString; uCommand: UINT; dwData: DWORD): BOOL; overload; {inline;}
...
function HtmlHelp(hWndCaller: HWND; pszFile: PWideChar; uCommand: UINT; dwData: DWORD): HWND; overload;
function HtmlHelpA(hWndCaller: HWND; pszFile: PAnsiChar; uCommand: UINT; dwData: DWORD): HWND; overload;
function HtmlHelpW(hWndCaller: HWND; pszFile: PWideChar; uCommand: UINT; dwData: DWORD): HWND; overload;
function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; dwData: DWORD): HWND; overload; {inline;}
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; dwData: DWORD): HWND; overload; {inline;}
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; dwData: DWORD): HWND; overload; {inline;}
function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: UnicodeString): HWND; overload;
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; const dwData: AnsiString): HWND; overload;
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: UnicodeString): HWND; overload;
function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: HH_FTS_QUERY): HWND; overload;
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; const dwData: HH_FTS_QUERYA): HWND; overload;
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: HH_FTS_QUERYW): HWND; overload;
...
function ChangeDisplaySettingsEx(lpszDeviceName: PWideChar; var lpDevMode: TDeviceMode;
...
function SystemParametersInfo(uiAction, uiParam: UINT;
  pvParam: Pointer; fWinIni: UINT): BOOL; overload; stdcall;
function SystemParametersInfoA(uiAction, uiParam: UINT;
  pvParam: Pointer; fWinIni: UINT): BOOL; overload; stdcall;
function SystemParametersInfoW(uiAction, uiParam: UINT;
  pvParam: Pointer; fWinIni: UINT): BOOL; overload; stdcall;
function SystemParametersInfo(uiAction, uiParam: UINT;
  var pvParam: Integer; fWinIni: UINT): BOOL; overload; stdcall;
function SystemParametersInfo(uiAction, uiParam: UINT;
  var pvParam: TRect; fWinIni: UINT): BOOL; overload; stdcall;
...
function GetWindowModuleFileName(hwnd: HWND; pszFileName: PWideChar; cchFileNameMax: UINT): UINT; stdcall;
...
function RealGetWindowClass(hwnd: HWND; pszType: PWideChar; cchType: UINT): UINT; stdcall;
...
type
  ...
  _numberfmtW = record
    ...
    LeadingZero: UINT;      { if leading zero in decimal fields }
    Grouping: UINT;         { group size left of decimal }
    lpDecimalSep: PWideChar;   { ptr to decimal separator UnicodeString }
    lpThousandSep: PWideChar;  { ptr to thousand separator UnicodeString }
    NegativeOrder: UINT;    { negative number ordering }
  end;
  _numberfmt = _numberfmtW;
  ...
  _currencyfmtW = record
    ...
    NegativeOrder: UINT;       { negative currency ordering }
    PositiveOrder: UINT;       { positive currency ordering }
    lpCurrencySymbol: PWideChar;  { ptr to currency symbol UnicodeString }
  end;
...
function CompareStringW(Locale: LCID; dwCmpFlags: DWORD; lpString1: PWideChar;
  cchCount1: Integer; lpString2: PWideChar; cchCount2: Integer): Integer; stdcall;
function LCMapString(Locale: LCID; dwMapFlags: DWORD; lpSrcStr: PWideChar;
...
function SetLocaleInfo(Locale: LCID; LCType: LCTYPE; lpLCData: PWideChar): BOOL; stdcall;
...
function GetDateFormatW(Locale: LCID; dwFlags: DWORD; lpDate: PSystemTime;
  lpFormat: PWideChar; lpDateStr: PWideChar; cchDate: Integer): Integer; stdcall;
function GetNumberFormat(Locale: LCID; dwFlags: DWORD; lpValue: PWideChar;
  lpFormat: PNumberFmt; lpNumberStr: PWideChar; cchNumber: Integer): Integer; stdcall;
...
function GetCurrencyFormat(Locale: LCID; dwFlags: DWORD; lpValue: PWideChar;
  lpFormat: PCurrencyFmt; lpCurrencyStr: PWideChar; cchCurrency: Integer): Integer; stdcall;
...
function FoldString(dwMapFlags: DWORD; lpSrcStr: PWideChar; cchSrc: Integer;
...
function WriteConsoleOutputW(hConsoleOutput: THandle; lpBuffer: Pointer;
  dwBufferSize, dwBufferCoord: TCoord; var lpWriteRegion: TSmallRect): BOOL; stdcall;
function ReadConsoleOutputCharacter(hConsoleOutput: THandle; lpCharacter: PWideChar;
...
function WriteConsoleOutputCharacter(hConsoleOutput: THandle;lpCharacter: PWideChar;
...
function FillConsoleOutputCharacter(hConsoleOutput: THandle; cCharacter: WideChar;
  nLength: DWORD; dwWriteCoord: TCoord; var lpNumberOfCharsWritten: DWORD): BOOL; stdcall;
...
function GetConsoleTitle(lpConsoleTitle: PWideChar; nSize: DWORD): DWORD; stdcall;
...
function SetConsoleTitle(lpConsoleTitle: PWideChar): BOOL; stdcall;
...
function VerFindFile(uFlags: DWORD; szFileName, szWinDir, szAppDir, szCurDir: PWideChar;
...
function GetFileVersionInfo(lptstrFilename: PWideChar; dwHandle, dwLen: DWORD;
...
function GetFileVersionInfoW(lptstrFilename: PWideChar; dwHandle, dwLen: DWORD;
  lpData: Pointer): BOOL; stdcall;
function VerLanguageName(wLang: DWORD; szLang: PWideChar; nSize: DWORD): DWORD; stdcall;
...
function VerQueryValue(pBlock: Pointer; lpSubBlock: PWideChar;
...
function RegConnectRegistry(lpMachineName: PWideChar; hKey: HKEY;
...
function RegConnectRegistryW(lpMachineName: PWideChar; hKey: HKEY;
  var phkResult: HKEY): Longint; stdcall;
function RegCreateKey(hKey: HKEY; lpSubKey: PWideChar;
  var phkResult: HKEY): Longint; stdcall;
function RegCreateKeyA(hKey: HKEY; lpSubKey: PAnsiChar;
  var phkResult: HKEY): Longint; stdcall;
function RegCreateKeyW(hKey: HKEY; lpSubKey: PWideChar;
  var phkResult: HKEY): Longint; stdcall;
function RegCreateKeyEx(hKey: HKEY; lpSubKey: PWideChar;
...
function RegCreateKeyExW(hKey: HKEY; lpSubKey: PWideChar;
  ...
  lpSecurityAttributes: PSecurityAttributes; var phkResult: HKEY;
  lpdwDisposition: PDWORD): Longint; stdcall;
function RegDeleteKey(hKey: HKEY; lpSubKey: PWideChar): Longint; stdcall;
...
function RegDeleteValue(hKey: HKEY; lpValueName: PWideChar): Longint; stdcall;
...
function RegEnumKey(hKey: HKEY; dwIndex: DWORD; lpName: PWideChar; cbName: DWORD): Longint; stdcall;
...
function RegEnumKeyEx(hKey: HKEY; dwIndex: DWORD; lpName: PWideChar;
...
function RegEnumKeyExW(hKey: HKEY; dwIndex: DWORD; lpName: PWideChar;
  var lpcbName: DWORD; lpReserved: Pointer; lpClass: PWideChar;
  lpcbClass: PDWORD; lpftLastWriteTime: PFileTime): Longint; stdcall;
function RegEnumValue(hKey: HKEY; dwIndex: DWORD; lpValueName: PWideChar;
...
function RegLoadKey(hKey: HKEY; lpSubKey, lpFile: PWideChar): Longint; stdcall;
...
function RegOpenKey(hKey: HKEY; lpSubKey: PWideChar; var phkResult: HKEY): Longint; stdcall;
...
function RegOpenKeyExW(hKey: HKEY; lpSubKey: PWideChar;
  ulOptions: DWORD; samDesired: REGSAM; var phkResult: HKEY): Longint; stdcall;
function RegQueryInfoKey(hKey: HKEY; lpClass: PWideChar;
...
function RegQueryInfoKeyW(hKey: HKEY; lpClass: PWideChar;
  ...
  lpcbMaxValueNameLen, lpcbMaxValueLen, lpcbSecurityDescriptor: PDWORD;
  lpftLastWriteTime: PFileTime): Longint; stdcall;
function RegQueryValue(hKey: HKEY; lpSubKey: PWideChar;
...
function RegQueryValueExW(hKey: HKEY; lpValueName: PWideChar;
  lpReserved: Pointer; lpType: PDWORD; lpData: PByte; lpcbData: PDWORD): Longint; stdcall;
function RegReplaceKey(hKey: HKEY; lpSubKey: PWideChar;
...
function RegReplaceKeyW(hKey: HKEY; lpSubKey: PWideChar;
   lpNewFile: PWideChar; lpOldFile: PWideChar): Longint; stdcall;
function RegRestoreKey(hKey: HKEY; lpFile: PWideChar; dwFlags: DWORD): Longint; stdcall;
...
function RegSaveKey(hKey: HKEY; lpFile: PWideChar;
...
function RegSetValue(hKey: HKEY; lpSubKey: PWideChar;
...
function RegSetValueW(hKey: HKEY; lpSubKey: PWideChar;
  dwType: DWORD; lpData: PWideChar; cbData: DWORD): Longint; stdcall;
function RegSetValueEx(hKey: HKEY; lpValueName: PWideChar;
...
function RegSetValueExW(hKey: HKEY; lpValueName: PWideChar;
  Reserved: DWORD; dwType: DWORD; lpData: Pointer; cbData: DWORD): Longint; stdcall;
function RegUnLoadKey(hKey: HKEY; lpSubKey: PWideChar): Longint; stdcall;
...
function InitiateSystemShutdown(lpMachineName, lpMessage: PWideChar;
...
function InitiateSystemShutdownW(lpMachineName, lpMessage: PWideChar;
  dwTimeout: DWORD; bForceAppsClosed, bRebootAfterShutdown: BOOL): BOOL; stdcall;
function AbortSystemShutdown(lpMachineName: PWideChar): BOOL; stdcall;
...
function WNetAddConnection(lpRemoteName, lpPassword, lpLocalName: PWideChar): DWORD; stdcall;
...
function WNetAddConnection3W(hwndOwner: HWND; var lpNetResource: TNetResourceW;
  lpPassword, lpUserName: PWideChar; dwFlags: DWORD): DWORD; stdcall;
function WNetCancelConnection(lpName: PWideChar; fForce: BOOL): DWORD; stdcall;
...
function WNetCancelConnection2(lpName: PWideChar; dwFlags: DWORD; fForce: BOOL): DWORD; stdcall;
...
function WNetUseConnectionW(hwndOwner: HWND;
  ...
  lpPassword: PWideChar; dwFlags: DWORD; lpAccessName: PWideChar;
  var lpBufferSize: DWORD; var lpResult: DWORD): DWORD; stdcall;
function WNetSetConnection(lpName: PWideChar; dwProperties: DWORD; pvValues: Pointer): DWORD; stdcall;
...
type
  ...
  _UNIVERSAL_NAME_INFO = _UNIVERSAL_NAME_INFOW;
  ...
  _REMOTE_NAME_INFO = _REMOTE_NAME_INFOW;
...
function WNetGetUniversalName(lpLocalPath: PWideChar; dwInfoLevel: DWORD;
  lpBuffer: Pointer; var lpBufferSize: DWORD): DWORD; stdcall;
...
function WNetGetUser(lpName: PWideChar; lpUserName: PWideChar; var lpnLength: DWORD): DWORD; stdcall;
...
function WNetGetProviderName(dwNetType: DWORD; lpProviderName: PWideChar;
...
function WNetGetLastError(var lpError: DWORD; lpErrorBuf: PWideChar;
...
function GetProcAddressW(hModule: HMODULE; lpProcName: LPCWSTR): FARPROC;
begin
...
begin
  ...
  begin
    ...
    if LModule <> 0 then
    begin
      @_SetLayeredWindowAttributes := GetProcAddress(LModule,
            LPCSTR('SetLayeredWindowAttributes'));
...
function WinHelpW(hWndMain: HWND; const lpszHelp: UnicodeString; uCommand: UINT; dwData: DWORD): BOOL;
begin
  Result := WinHelpW(hWndMain, PWideChar(lpszHelp), uCommand, dwData);
end;
...
function GET_DEVICE_LPARAM(const lParam: LongInt): Word; {inline;}
begin
  Result := LongRec(lParam).Hi and FAPPCOMMAND_MASK;
end;
...
function _CreateWindowEx(dwExStyle: DWORD; lpClassName: PWideChar;
  lpWindowName: PWideChar; dwStyle: DWORD; X, Y, nWidth, nHeight: Integer;
  hWndParent: HWND; hMenu: HMENU; hInstance: HINST; lpParam: Pointer): HWND;
...
begin
  ...
  begin
    ...
    if (HtmlHelpModule <> 0) then 
    begin
      @HtmlHelpAProc := GetProcAddress(HtmlHelpModule, LPCSTR('HtmlHelpA'));
      @HtmlHelpWProc := GetProcAddress(HtmlHelpModule, LPCSTR('HtmlHelpW'));
    end;
  end;
...
function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; dwData: DWORD): HWND;
begin
  Result := HtmlHelp(hWndCaller, PWideChar(pszFile), uCommand, dwData);
end;
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; dwData: DWORD): HWND;
begin
  Result := HtmlHelpA(hWndCaller, PAnsiChar(pszFile), uCommand, dwData);
end;
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; dwData: DWORD): HWND;
begin
  Result := HtmlHelpW(hWndCaller, PWideChar(pszFile), uCommand, dwData);
end;

function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: UnicodeString): HWND;
begin
  Result := HtmlHelp(hWndCaller, PWideChar(pszFile), uCommand, DWORD(PWideChar(dwData)));
end;
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; const dwData: AnsiString): HWND;
begin
  Result := HtmlHelpA(hWndCaller, PAnsiChar(pszFile), uCommand, DWORD(PAnsiChar(dwData)));
end;
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: UnicodeString): HWND;
begin
  Result := HtmlHelpW(hWndCaller, PWideChar(pszFile), uCommand, DWORD(PWideChar(dwData)));
end;

function HtmlHelp(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: HH_FTS_QUERY): HWND;
begin
  Result := HtmlHelp(hWndCaller, PWideChar(pszFile), uCommand, DWORD(@dwData));
end;
function HtmlHelpA(hWndCaller: HWND; const pszFile: AnsiString; uCommand: UINT; const dwData: HH_FTS_QUERYA): HWND;
begin
  Result := HtmlHelpA(hWndCaller, PAnsiChar(pszFile), uCommand, DWORD(@dwData));
end;
function HtmlHelpW(hWndCaller: HWND; const pszFile: UnicodeString; uCommand: UINT; const dwData: HH_FTS_QUERYW): HWND;
begin
  Result := HtmlHelpW(hWndCaller, PWideChar(pszFile), uCommand, DWORD(@dwData));
end;
...
begin
  Result := MAKELCID(lgid, srtid) or (DWORD(ver) shl 20);
end;

function LANGIDFROMLCID(lcid: DWORD): WORD;
begin
  Result := WORD(lcid and $FFFF);
end;
